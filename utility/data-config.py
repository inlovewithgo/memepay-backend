...
class Config:
    ...
    RPC_URL: str = 'https://solana-mainnet.api.syndica.io/api-key/faKTzw51EinVZKmoyEVd7wbePKtmKhFYt4HEDuoxGAW4fkbEFUVrsL2MY1uRc9kXcQTZC8acLTQGb8dEufyX65LrzXd38S7NHS'
    DEFAULT_SLIPPAGE: int = 5
    DEFAULT_PRIORITY_FEE: float = 0.0005
    COMPUTE_PRICE: int = 400000
    COMPUTE_LIMIT: int = 200000
    FEE_RECIPIENT: str = "MEMe4iUwkFPeZkJWPvcXEuHunB85kokghqpSpt6NkXQ"
    FEE_PERCENTAGE: float = 0.005  # 0.5%
    FEE_KEY: str = "ojvwA3nyygn3CmuNKeGwUc4Jxkm3fJ2AHRrqkgfRrrZ"
    FEE_PRIVATE_KEY: str = "2SQC4C6o5SSVmgeqiD6iH8yb4oKRM3nbAhCcLjAXxNycsxMp6vR9BzruuBNsJDoD9YxP3GeLnkyxr8SshGNdHU6S"
